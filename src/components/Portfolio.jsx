    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          ...
          <p className="py-4">Visualize meus projetos aqui.</p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          {portfolios.map(({ id, src }) => (
            <div
              key={id}
              className="shadow-md shadow-yellow-100 rounded-lg duration-200 hover:scale-105"
            >
              <img src={src} alt="" className="rounded-t-xl" />
              <div className="flex items-center justify-center">
                <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:opacity-80 hover:text-yellow-100">
                  Visualizar
                </button>
                <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:opacity-80 hover:text-yellow-100">
                  Código
